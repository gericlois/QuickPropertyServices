...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Blocked Providers
            </h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item active">Blocked Providers</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                            <?php
        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Blocked Provider Data Table</h5>
                            ...
                            ?>
                                ...
                                echo "<tr><td colspan='10' class='text-center'>No Blocked Providers found</td></tr>";
                            }
                            ?>
                                </tbody>
                            </table>
