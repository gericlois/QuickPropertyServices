...
<head>
  ...
  <title>Provider Profile | Account Settings – Fixing Techs</title>
  <meta name="description" content="Manage your provider profile with Fixing Techs. Update contact info, skills, availability, and account settings securely.">
  <meta name="keywords" content="provider profile, Fixing Techs provider, account settings, update profile, contractor profile, provider account, manage skills, provider settings">
