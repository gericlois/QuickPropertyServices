...
// Fetch latest message per provider
$query = "
    SELECT 
        m.message_id,
        m.client_id,
        ...
        u.last_name
    FROM messages m
    INNER JOIN providers p ON m.provider_id = p.provider_id
...
// Count threads (one per provider)
$count_query = "
...
<head>
  ...
  <title>Client Messages | Inbox – Fixing Techs</title>
  <meta name="description" content="View your messages with Fixing Techs staff. Stay informed and communicate directly through our secure client messages portal.">
  <meta name="keywords" content="client messages, Fixing Techs messaging, client inbox, communication portal, service messages, client staff messaging, secure client messages">
    ...
    <main class="main">
        ...
        <section id="messages" class="services section light-background">
            <div class="container section-title" data-aos="fade-up">
                <h2>My Messages</h2>
                <p>Here are all your provider messages.</p>
            </div>
            <div class="container">
                    ...
                    <ul class="list-group">
                        ...
                        ?>
                            <li class="list-group-item d-flex justify-content-between align-items-start <?= $row['status'] === 'unread' ? 'list-group-item-warning' : '' ?>">
                                ...
                                <div class="btn-group">
                                    <a href="client-message-view.php?message_id=<?= urlencode($row['message_id']); ?>" class="btn btn-sm btn-primary">View</a>
                                </div>
                            </li>
                        <?php endwhile; ?>
                    </ul>
